...
//             //     }
//             // };
//             let mut value = match &mut self.word {
//                 Ok(Words::Comment(comment)) => match current {
//                     '\r' | '\n' => Ok(Words::BreakLine),
//                     _ => {
...
//                     }
//                 },
//                 Ok(Words::Sign(previous)) => match current {
...
//                     '/' => {
//                         if *previous == '/' {
//                             self.word = Ok(Words::Comment(String::from("")));
//                             continue;
//                         } else {
//                             Ok(Words::Sign('/'))
//                         }
...
//                 _ => todo!(),
//             };
//             swap(&mut value, &mut self.word);
//             return Some(value.and_then(|content| Ok(content)));
//         }
//         match &self.word {
//             Ok(Words::Empty) => None,
//             _ => {
